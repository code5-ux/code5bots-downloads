...
**CODE 5 BOTS** — это десктопное приложение для Windows, которое автоматизирует однообразные занятия в GTA 5 RP. Один клик — и бот сам выполняет выбранное действие: копает в шахте, работает на стройке, разгружает порт, качается в зале, готовит и т.д. Управление всеми ботами собрано в одном удобном окне.

Приложение распространяется **по лицензии** и привязывается к вашему устройству. Обновления приходят **автоматически** — новые версии выкладываются в этот репозиторий, а программа сама предлагает установить их при запуске.
...
| Бот              | Что делает                                              |
|------------------|---------------------------------------------------------|
| ⛏ **Шахта**       | Автоматическая добыча и сдача ресурсов                  |
| 🏗 **Стройка**    | Автовыполнение работы на стройке                        |
| 🚢 **Порт**       | Разгрузка/погрузка ящиков в порту                       |
| 💪 **Качалка**    | Прокачка в спортзале + автоеда                          |
| 🍳 **Готовка**    | Приготовление блюд (венчик, огонь, вода, мука)          |
| 🐄 **Фермы**      | Работа на ферме (дойка/сбор)                            |
| 🧱 **Демонтаж**   | Авторабота на демонтаже с имитацией движений человека   |
| 📱 **Авто-КПК**   | Автоматизация действий в КПК                            |
| 💤 **AFK-система**| Удержание персонажа в активности без «афк-кика»         |
